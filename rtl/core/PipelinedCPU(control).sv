...
module PipelinedCPU (clk, reset);
    ...
    logic [63:0] IFID_instruction_64; 
    logic [31:0] IFID_instruction_in;


    mux64_2to1 flushMUX (.a({32'b0, instruction}), .b(64'b0), .sel(reset), .out(IFID_instruction_64));
    assign IFID_instruction_in = IFID_instruction_64[31:0];
